...
from eval_scripts.semi.eval_found_gnn import build_args
...
if __name__ == "__main__":
    ...
    gnn_list = [
        {0: {'conv_type': 'sage', 'out_dim': 256}, 1: {'conv_type': 'sage', 'out_dim': 7}},
        {0: {'conv_type': 'arma', 'out_dim': 128}, 1: {'conv_type': 'arma', 'out_dim': 6}},
        {0: {'conv_type': 'gcn', 'out_dim': 32}, 1: {'conv_type': 'arma', 'out_dim': 3}},
    ]
